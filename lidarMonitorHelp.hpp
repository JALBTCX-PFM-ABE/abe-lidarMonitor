...
QString prefsText = 
  lidarMonitor::tr ("<img source=\":/icons/prefs.png\"> Click this button to change program preferences.  This includes "
                   "position format and the colors.");
QString modeText = 
  lidarMonitor::tr ("<img source=\":/icons/mode_line.png\"> <img source=\":/icons/mode_dot.png\"> Click this button to toggle between line and dot drawing "
                   "modes for the wave display.  When selected the waves are drawn as lines, when unselected the waves are drawn "
                   "as unconnected dots.");

QString quitText = 
  lidarMonitor::tr ("<img source=\":/icons/quit.png\"> Click this button to <b><em>exit</em></b> from the program.  "
...
QString mapText = 
  lidarMonitor::tr ("This is the lidarMonitor program, a companion to the pfmEdit program for viewing Charts "
                     "LIDAR HOF and TOF, or CZMIL CPF record data in a textual form.");

QString bGrpText = 
  lidarMonitor::tr ("Select the format in which you want all geographic positions to be displayed.");

QString falseAlarmText = 
  lidarMonitor::tr ("Select the probability of a false alarm when detecting a cube in Optech's CZMIL data set.  This value will be used to "
                    "determine the probability of detection of a cube based on the d_index_cube value.  The probability of detection and this "
                    "false alarm probability will be displayed next to the D_index_cube field.");
